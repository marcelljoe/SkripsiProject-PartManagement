...
<tr style="display: none;">
	...
	<tr>
	<td>Tanggal Pengecekan<input type="date" class="form-control" name="tgl_cek" placeholder="Tanggal Pengecekan"></td>
	</tr>
	<tr>
	<td>Tambahkan Keterangan<input type="text" class="form-control" name="keterangan" placeholder="Keterangan"></td>
	</tr>
	<tr style="display: none;">
	<td>Keputusan<input type="text" class="form-control" name="keputusan" value='NG' placeholder="Keputusan" readonly></td>
	</tr>
	<tr style="display: none;">
	<td>Status<input type="text" class="form-control" name="status_p" value='Unready' placeholder="Status" readonly></td>
	</tr>
	<tr>
		<td>
