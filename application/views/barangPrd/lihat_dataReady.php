...
<table class="table table-bordered table-striped" width="100%" id="example1">
	...
	{ 
		...
		<td>$d->tgl_cek</td>
		<td>$d->keputusan</td>
		<td>".anchor('produksi/setReq/'.$d->id,'Request',array('class'=> 'btn btn-primary btn-xs btn-block', 'data-target' => '#ModalReq', 'data-toggle' => 'modal'))."</td>
		</tr>";
...
<!-- ini modal -->
<div id="ModalReq" class="modal fade" tabindex="-1" role="dialog">
...
<?php
echo form_open('produksi/setReq', "name='modal_popup'");
?>
