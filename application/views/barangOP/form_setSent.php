...
<tr style="display: none;">
	...
	<tr style="display: none;">
	<td>Request<input type="text" class="form-control" name="request" value="Sent" placeholder="Request" readonly></td>
	</tr>
	<tr>
		<td>
			<button type="submit" class ="btn btn-primary" onclick="return confirm('Kirim barang? Tolong periksa kembali Raw Material!')" name="submit">Kirim</button>
